...
const emptyForm = { username: "", password: "", full_name: "", email: "", is_admin: false };
...
export default function UsersPage() {
  ...
  function startEdit(u: AppUser) {
    setEditId(u.id);
    setEditForm({ full_name: u.full_name || "", email: u.email || "", is_admin: u.is_admin, is_active: u.is_active, password: "" });
  }
                    ...
                    <>
                      ...
                      <td className="px-4 py-3">
                        {u.is_admin ? (
                          ...
                          <span className="px-2 py-0.5 bg-gray-100 text-gray-600 rounded-full text-xs">Usuário</span>
                        )}
                      </td>
                      <td className="px-4 py-3">
                        {u.is_active ? (
